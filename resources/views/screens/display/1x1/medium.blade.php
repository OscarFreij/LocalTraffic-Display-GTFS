<x-display-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl 2xl:text-4xl text-center text-gray-800 dark:text-gray-200 leading-tight">
            {{ $screen->long_name }}
        </h2>
    </x-slot>
    <div class="pb-3 pt-3 w-full">
        <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-2 sm:p-4 pl-4  bg-white dark:bg-gray-800 sm:rounded-lg">
                <div class="max-w-auto text-center font-semibold text-xl 2xl:text-4xl text-start text-gray-800 dark:text-gray-200 leading-tight">
        ...
        <div class="pb-3 pt-3 w-full">
            <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="pl-4 sm:pl-8 bg-green-800 shadow sm:rounded-lg">
                    <div class="py-2 sm:py-4 pl-4 sm:pl-8 pr-8 sm:pr-16 bg-white dark:bg-gray-800 sm:rounded-lg sm:rounded-s-none">
                        <div class="max-w-auto grid sm:grid-cols-3 grid-cols-2 sm:grid-rows-1 grid-rows-2 font-semibold text-xl 2xl:text-4xl text-start text-gray-800 dark:text-gray-200 leading-tight">
        ...
        <div class="pb-3 pt-3 w-full">
            <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="pl-4 sm:pl-8 bg-cyan-800 shadow sm:rounded-lg">
                    <div class="py-2 sm:py-4 pl-4 sm:pl-8 pr-8 sm:pr-16 bg-white dark:bg-gray-800 sm:rounded-lg sm:rounded-s-none h-50">
                        <div class="max-w-auto grid sm:grid-cols-3 grid-cols-2 sm:grid-rows-1 grid-rows-2 font-semibold text-xl 2xl:text-4xl text-start text-gray-800 dark:text-gray-200 leading-tight">
                            <p class="text-start sm:col-span-1 col-span-2 row-span-1">#ROUTE_NUMBER# : #TRIP_DESTINATION#</p>
    ...
    <div class="hidden" name="template_row_noDepartures">
        <div class="pb-3 pt-3 w-full">
            <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="p-2 sm:p-4 pl-4  bg-white dark:bg-gray-800 sm:rounded-lg">
                    <div class="max-w-auto text-center font-semibold text-xl 2xl:text-4xl text-start text-gray-800 dark:text-gray-200 leading-tight flex flex-col justify-center">
                        <p class="text-center mb-4">No departures for this station was found!</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="min-w-16 h-16 2xl:min-w-128 2xl:h-128 stroke-red-600 self-center">
